...
Occasionally, you may find that an operation could return either errors, warnings or _both_. For example, `log` outputs a warning when it's given negative numbers but throws an error if its input is non-numeric. Regression functions are particularly prone to this.
